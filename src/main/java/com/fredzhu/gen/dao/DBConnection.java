...
public class DBConnection {
	...
	private DBConnection(Configuration config) {
		...
		p.setUrl(config.getConfiguration("jdbc.url"));
		p.setDriverClassName(config.getConfiguration("jdbc.driver"));
		p.setUsername(config.getConfiguration("jdbc.username"));
		p.setPassword(config.getConfiguration("jdbc.password"));
	...
	public static Connection getConnection(Configuration config) {
		try {
			Connection con = new DBConnection(config).getDataSource().getConnection();
			return con;
